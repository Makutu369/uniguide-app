...
const Navbar = ({ children, route, tour }) => {
  return (
    <div className="flex border-b  border-black/10 dark:border-white/10 py-2 sm:px-16 px-6 justify-between items-center w-full h-14  bg-white dark:bg-graySecondary ">
