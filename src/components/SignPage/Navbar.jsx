...
const Navbar = ({ children, route, tour }) => {
  return (
    <div className="flex border-b  border-black/10 bg-white dark:border-white/10 py-2 sm:px-16 px-6 justify-between items-center w-full h-[8vh]   dark:bg-graySecondary ">
